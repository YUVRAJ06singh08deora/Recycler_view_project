...
public class Category_model {
    ...
    public Category_model(int productImage1, String productName1, String shortDesc1, String price1, int addBtn1,int productImage2, String productName2, String shortDesc2, String price2, int addBtn2) {
